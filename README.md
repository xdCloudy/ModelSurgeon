...
| Constraint negotiation and infeasibility | **v2.5 bounded decision-quality study** | Measured infeasibility and Pareto alternatives are replayed over versioned fixture campaigns; explicit amendments retain immutable evidence and new campaign identity. Prediction-only alternatives are a retained, never-shippable control. See the [v2.5 decision-quality protocol](docs/design/negotiation-decision-quality.md). |
