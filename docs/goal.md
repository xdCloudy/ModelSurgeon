...
| v2.5 | Explain measured infeasibility and present Pareto alternatives without silently changing constraints. | v2.4 plus v2.0 evidence/approval primitives. | **Closed:** the bounded decision-quality study permits measured-only alternatives with immutable, user-approved objective amendments; prediction-only alternatives remain never shippable. |
