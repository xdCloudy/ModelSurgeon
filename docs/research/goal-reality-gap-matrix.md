...
| Stateful evidence flywheel | The first-party HF search now retains real pre-mutation feature records for every measured candidate in durable active-search evidence. | Partial | Publish optimize observations into the reusable feature/evidence store and enforce rediscovery/state-dependent candidates. |
