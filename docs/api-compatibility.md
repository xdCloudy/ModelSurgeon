...
| `modelsurgeon.evaluation` | Typed benchmark/evaluation reports, frozen protocol and baseline evidence, quantization-order attribution, structured artifact reconciliation, compatibility evidence, provenance-complete benchmark cells, and bounded llama.cpp validation. |
