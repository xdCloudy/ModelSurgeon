...
| `modelsurgeon.evaluation` | Typed benchmark/evaluation reports, frozen protocol and baseline evidence, compatibility evidence, provenance-complete benchmark cells, and bounded llama.cpp validation. |
